...
bool AudioGraphManager::setMode(PerformanceMode mode) {
 ...
 // MODE6_SETMODE_HOOK
 {
 static PerformanceMode prev = PerformanceMode::SynthOnly;
 const bool entering = (mode == PerformanceMode::Talkbox);
 const bool leaving  = (prev == PerformanceMode::Talkbox && !entering);
 if (entering) {
 ...
 std::string& out_r)
{
 ...
 Logger::warning("resolveMvx2uPlaybackPorts: using hardcoded MVX2U port names");
 }
...
bool AudioGraphManager::buildMode6()
{
 ...
 "alsa_output.pci-0000_04_00.6.HiFi__Headphones__sink:playback_FL";
 const std::string pci_r =
 "alsa_output.pci-0000_04_00.6.HiFi__Headphones__sink:playback_FR";
